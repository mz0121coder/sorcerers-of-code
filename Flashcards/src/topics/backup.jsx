...
<div
	className='card'
	style={{ backgroundColor: 'lightgrey' }}
	onMouseOver={() => handleCardClick(8)}>
	<h3>What is the CSS property used to add background color to an element?</h3>
